...
//  List and Navigation
//
//  Created by Pablo Segovia on 10/12/2022.
//  From page https://www.youtube.com/watch?v=Cl2gAs7hySk
...
struct ContentView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Emoji") // en el video tiene otro parámetro pero está en desuso
        }
    }
}
...
struct EmojiItem: Identifiable {
    let id = UUID() // if ":" unexpected initializer
    let emoji: String
    let name: String
